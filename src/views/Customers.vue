<template>
    <main>
        ...
        <div v-if="allCustomer.length" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 xl:flex flex-wrap">
            <CustomerCard v-for="customer in allCustomer" :customer="customer" :key="customer.id" />
        </div>
